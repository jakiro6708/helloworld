...
1. Clone this repo:
	...
	git clone --depth=1 https://github.com/jakiro6708/helloworld.git package/helloworld
	```
...
1. Add new submodule:
	...
	```bash
	rm -rf package/helloworld
	git submodule add -f --name helloworld https://github.com/jakiro6708/helloworld.git package/helloworld
	```
...
1. Add new feed:
	...
	echo "src-git helloworld https://github.com/jakiro6708/helloworld.git" >> "feeds.conf.default"
	```
